...
<head>
  ...
  <meta name="keywords" content="bootstrap, bootstrap4" />
		...
		<title>Informasi Tentang Honda Vario 125 cbs </title>
	</head>
	...
	<body>
		...
		<nav class="custom-navbar navbar navbar navbar-expand-md navbar-dark bg-dark" arial-label="Furni navigation bar">
			...
			<div class="container">
				<a class="navbar-brand" href="index.html">Honda<span>.</span></a>
		...
		<footer class="footer-section">
			<div class="container relative">
				...
				<div class="sofa-img">
					<img src="images/honda2.png" alt="Image" class="img-fluid">
				</div>
				...
				<div class="row g-5 mb-5">
					<div class="col-lg-4">
						<div class="mb-4 footer-logo-wrap"><a href="#" class="footer-logo">Honda Vario 125 cbs<span>.</span></a></div>
						<p class="mb-4">Astra Honda Motor memasarkan New Honda Vario 125 dengan kelir dan striping baru. Akibatnya Vario 125 CBS terlihat lebih sporty dan Vario CBS-ISS tampil lebih premium. 
							...
							Makanya, model ini diklaim paling irit di kelas, dengan konsumsi BBM hingga 51,7 km/liter. Emisinya juga dikatakan lebih baik dari standar Euro3. </p>
                        <h2>Harga Honda Vario 125</h2>
                       <p>Harga Vario 125 adalah antara Rp 22,55 Juta hingga Rp 24,45 Juta.</p>

					   <h2>Varian Honda Vario 125</h2>
					   <p>Ada 3 varian yang tersedia dari Vario 125: CBS, CBS ISS dan CBS ISS SP.</p>
